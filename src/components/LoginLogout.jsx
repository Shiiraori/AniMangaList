    ...
    const handleGoogleLogin = () => {
      ...
      return (
        <div className="welcome">
          <h1 className="position-absolute top-0 start-50 translate-middle-x">AniMangaList</h1>
          <div className="position-absolute top-50 start-50 translate-middle">
            {isRegistering ? (
              <>
                ...
                />
                <button className="btn btn-success my-2" onClick={handleRegister}>Register</button>
